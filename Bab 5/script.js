...
function main() {
    ...
    video.src = 'textures/awan cerah.mp4'; // Ganti dengan path video kamu
    video.loop = true;
    ...
    const waterTexture = textureLoader.load('textures/Poliigon_RattanWeave_6945_Roughness.jpg');
    ...
    const planeTextureMap = textureLoader.load('textures/pasir.png');
